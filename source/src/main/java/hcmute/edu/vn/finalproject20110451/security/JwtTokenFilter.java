...
public class JwtTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,
                                    FilterChain filterChain) throws AuthenticationException, ServletException, IOException, UsernameInvalidException {
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            try {
                ...
                if (userDetails != null && jwtTokenUtils.validateToken(jwtToken, userDetails)) {
                    ...
                    log.info(userDetails.getUsername() + " HAS BEEN REQUESTED WITH ROLES: " + userDetails.getAuthorities().toString());
                }
